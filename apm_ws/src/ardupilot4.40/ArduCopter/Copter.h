...
public:
    ...
    friend class ModeStab_to_Loit;//2023-08-27
    Copter(void);
...
# include USERHOOK_VARIABLES
    ...
    void Log_Write_Stab_to_loit_msg(float thr,int16_t rngfinder,int16_t z_spd,uint8_t air_status,uint8_t ground_status,uint8_t ju_sta);
    void log_init(void);
    ...
    uint32_t stab_to_loit_time;//2023-2-9
...
#endif
     ModeStab_to_Loit stab_to_loit;//2023-3-19
    // mode.cpp

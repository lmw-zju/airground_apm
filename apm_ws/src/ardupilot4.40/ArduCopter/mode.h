...
//2023-3-19
class ModeStab_to_Loit : public Mode 
{

public:
   // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::STAB_TO_LOIT; }

    bool init(bool ignore_checks) override;
    void run() override;
    void exit() override;//2023-08-27
    bool requires_GPS() const override { return true; }//false
    bool has_manual_throttle() const override { return false; }
    bool allows_arming(AP_Arming::Method method) const override { return true; };
    bool is_autopilot() const override { return false; }
    bool has_user_takeoff(bool must_navigate) const override { return true; }
...
protected:
    ...
    const char *name() const override { return "STAB_TO_LOIT"; }
    const char *name4() const override { return "STOL"; }
